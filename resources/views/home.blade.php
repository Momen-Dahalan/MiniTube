...
<div class="container py-5 d-flex flex-column align-items-center">
    ...
    <form action="{{ route('search') }}" method="GET" class="d-flex mb-4 w-100" style="max-width: 800px;">
        <input type="text" name="query" value="{{ request('query') }}" placeholder="{{ __('messages.search_placeholder') }}" class="form-control me-2" required>
                    ...
                    <div class="card h-100 shadow-sm rounded-4 border-0 hover-card overflow-hidden">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-3 text-center">
                                <a href="{{ route('videos.show', $video) }}" class="btn btn-outline-primary btn-sm px-4 fw-semibold">
